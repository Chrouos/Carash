...
from tools.accuracy_tool import print_micro_result
from sklearn.metrics import classification_report

logger = logging.getLogger(__name__)
# logging.basicConfig(filename='log/CNN.log', encoding='utf-8', level=logging.DEBUG)
logging.basicConfig(handlers=[logging.FileHandler(filename="log/CNN.log", 
